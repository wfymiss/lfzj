...
import com.ovov.lfzj.base.net.IOThread;
...
public class ScaleImageView {
    ...
    private void init() {
        ...
        download.setOnClickListener(v -> {
            try {
                MediaStore.Images.Media.insertImage(activity.getContentResolver(), downloadFiles.get(selectedPosition).getAbsolutePath(), downloadFiles.get(selectedPosition).getName(), null);
