...
public class TransmitpopupWindow extends PopupWindow {
    ...
    public TransmitpopupWindow(Context context) {
        super(context);
        init(context);   //布局
        setPopupWindow();   //布局属性
    }
    ...
    private void init(Context context) {
        ...
        mview=infalter.inflate(R.layout.transmit_select,null);    //绑定布局
        //获取控件
        ...
        btnPhoto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                RxBus.getDefault().post(new TransmitSquareEvent());
                dismiss();
            }
        });
        btnSelect.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RxBus.getDefault().post(new ShareSquareEvent());
                dismiss();
            }
        });
    }
