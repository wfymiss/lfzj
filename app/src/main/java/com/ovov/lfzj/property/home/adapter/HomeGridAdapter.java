package com.ovov.lfzj.property.home.adapter;
...
public class HomeGridAdapter extends BaseAdapter {
    ...
    Context context;
    public HomeGridAdapter(List<Map<String,Object>> mUI, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mLayoutInflater.inflate(R.layout.lfgj_grid_item,
                    parent, false);
